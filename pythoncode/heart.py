...
b = np.linspace(-5, -3.5, size_steps)
c = np.linspace(-2, -2, size_steps)
d = np.linspace(-1, -0.016, size_steps)
scalex = np.linspace(1, 1.25, size_steps) * 10
scaley = np.linspace(1, 1.5, size_steps) * 10
...
bloom_indices = np.linspace(0, size_steps - 2, 5)
shrink_indices = np.linspace(size_steps - 10, 0, 20)
